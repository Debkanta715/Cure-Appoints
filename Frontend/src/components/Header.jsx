...
<div  className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
    ...
    <p>Simply browse throught our extensive list of trusted doctors, <br className='hidden sm:block'/>schedule your apppointment hassle-free</p>
</div>
  <a className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300 ' href="#speciality">Book appointment 
    <img className='w-3' src={assets.arrow_icon} alt="" /></a>
      ...
      <div className='md:w-1/2 relative'>
          ...
          <img src={assets.header_img} alt="" className='w-full md:absolute bottom-0 h-auto rounded-b-lg' />
      </div>
